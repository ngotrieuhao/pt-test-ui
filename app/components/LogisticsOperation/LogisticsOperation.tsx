...
const LogisticsOperation = () => {
  return (
    <section className="max-w-6xl mx-auto px-6 md:py-16 py-0">
      <div className="relative md:h-[750px] h-full">
        ...
        <div className="mx-auto md:absolute relative text-center md:left-1/2 md:top-[90%] w-[92%] md:-translate-x-1/2 md:-translate-y-1/2 md:w-3/4 lg:w-[1084px] lg:h-[288px]">
          <div className="rounded-[32px] bg-white/95 p-6 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur-sm">
